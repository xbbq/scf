...
class scModel(nn.Module):
    ...
    def forward(self, input_seq, full,mask_positions,encoder_position_gene_ids, encoder_mask=None, decoder_mask=None):
        ...
        # tensor = torch.from_numpy(encoder_position_gene_ids)
