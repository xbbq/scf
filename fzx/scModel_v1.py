...
class scModel(nn.Module):
    ...
    def forward(self, input_seq, full_seq,mask_positions,encoder_position_gene_ids, encoder_mask=None, decoder_mask=None):
        ...
        tensor = encoder_position_gene_ids.to(self.device)
        ...
        tensor = encoder_position_gene_ids.to(self.device)
        decoder_input = get_full_seq(encoder_output,tensor,full,self.pad_token_id)
